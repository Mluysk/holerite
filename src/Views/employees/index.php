                    ...
                    <table>
                        ...
                        <?php foreach ($activeEmployees as $employee): ?>
                            <tr>
                                ...
                                <td class="text-right actions actions--compact">
                                    <a href="?action=show_employee&id=<?= $employee->getId(); ?>" class="button button-ghost button-pill button-compact">
                                        <i class="button__icon bi bi-eye" aria-hidden="true"></i>
                                        <span>Detalhes</span>
                                    </a>
                                    <a href="?action=edit_employee&id=<?= $employee->getId(); ?>" class="button button-secondary button-pill button-compact">
                                        <i class="button__icon bi bi-pencil-square" aria-hidden="true"></i>
                                        <span>Editar</span>
                                    </a>
                                    <form method="post" action="?action=terminate_employee&id=<?= $employee->getId(); ?>" onsubmit="return confirm('Confirmar desligamento deste colaborador?');">
                                        <input type="hidden" name="termination_date" value="<?= htmlspecialchars($todayValue); ?>">
                                        <button type="submit" class="button button-warning button-pill button-compact">
                                            <i class="button__icon bi bi-person-dash" aria-hidden="true"></i>
                                            <span>Desligar</span>
                                        </button>
                                    </form>
