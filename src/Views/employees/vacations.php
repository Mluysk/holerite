        ...
        <div class="table-responsive">
            <table>
                ...
                <?php foreach ($entries as $entry): ?>
                    ...
                    $highlight = '';
                    if ($cycle !== null) {
                        $available = $cycle['available_from'] ?? null;
                        $concessionEnd = $cycle['concession_end'] ?? null;
                        $eligible = !empty($cycle['eligible']);
                        $notice = !empty($cycle['notice']);

                        if (
                            $eligible
                            && $available instanceof DateTimeImmutable
                            && $available <= $today
                            && ($concessionEnd instanceof DateTimeImmutable ? $today <= $concessionEnd : true)
                        ) {
