        ...
        <div class="payroll-create__grid">
            ...
            <aside class="payroll-create__aside">
                <div class="card payroll-summary">
                    ...
                    <p class="muted" id="advance-note" style="display: <?= $defaultHasAdvance ? 'block' : 'none'; ?>;">Com o adiantamento habilitado, escolha antecipar 40%, 50% ou defina um percentual personalizado do líquido; o desconto aparecerá logo abaixo do salário base no holerite impresso.</p>
                            ...
                            <div class="form-grid form-grid--thirds">
                                <div class="form-field">
                                    ...
                                    <select name="advance_ratio" id="advance_ratio">
                                        <option value="0.4" <?= $defaultAdvanceRatioMode === '0.4' ? 'selected' : ''; ?>>40% do líquido</option>
                                        <option value="0.5" <?= $defaultAdvanceRatioMode === '0.5' ? 'selected' : ''; ?>>50% do líquido</option>
