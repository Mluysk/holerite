        ...
        <div class="payroll-create__grid">
                ...
                <div class="card form-card">
                    <header class="form-card__header">
                        ...
                        <div>
                            ...
                            <p class="muted">Inclua ganhos como horas extras, adicional noturno, comissões, bônus ou gratificações.</p>
                        </div>
                    </header>
                    <div class="form-card__body">
            ...
            <aside class="payroll-create__aside">
                <div class="card payroll-summary">
                    ...
                    <p class="muted" id="advance-note" style="display: <?= $defaultHasAdvance ? 'block' : 'none'; ?>;">Com o adiantamento habilitado, escolha antecipar 40% ou 50% do líquido e o desconto aparecerá logo abaixo do salário base no holerite impresso.</p>
