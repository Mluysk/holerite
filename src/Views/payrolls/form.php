...
<section>
    ...
    <form method="post" action="?action=store_payroll" id="payroll-form" data-default-type="<?= htmlspecialchars($selectedType); ?>">
        ...
        <div class="grid" style="margin-top:1.5rem;">
            ...
            <div class="card">
                ...
                <div style="margin-bottom:1rem;">
                    ...
                    <label class="muted" for="use_transport" style="display:flex;align-items:center;gap:0.5rem;cursor:pointer;margin-bottom:0.35rem;font-weight:600;color:inherit;">
                        <input type="checkbox" id="use_transport" name="use_transport" value="1" <?= $defaultUseTransport ? 'checked' : ''; ?>>
                        Aplicar vale-transporte (6% do salário base)
                    </label>
                    <p class="muted" style="margin:0;">Quando habilitado, o desconto é calculado automaticamente sobre o salário base ou valor proporcional deste holerite.</p>
                </div>
        ...
        <div class="card" style="margin-top:1.5rem;">
            ...
            <p class="muted">Vale-transporte (6%): <strong id="transport-deduction-total">R$ 0,00</strong></p>
            <p class="muted">Vales informados: <strong id="vale-deduction-total">R$ 0,00</strong></p>
            <p class="muted">Total de vales: <strong id="vale-deduction-sum">R$ 0,00</strong></p>
