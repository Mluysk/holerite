...
<section class="receipt-wrapper">
    <div class="holerite-print-alert" role="status">
        <i class="bi bi-check-circle-fill" aria-hidden="true"></i>
        <span>Holerite gerado com sucesso.</span>
    </div>
    <?php foreach ([
        ...
        <div class="holerite">
            ...
            <div class="holerite-signature">
                ...
                <div class="holerite-signature-footer">
                    <div class="holerite-signature-date" aria-hidden="true">
                        <div class="holerite-date-row">
                            <div class="holerite-date-slot">
                                <span class="holerite-date-slot-label">DIA</span>
                                <span class="holerite-date-slot-line"></span>
                            </div>
                            <span class="holerite-date-slot-separator"></span>
                            <div class="holerite-date-slot">
                                <span class="holerite-date-slot-label">MÊS</span>
                                <span class="holerite-date-slot-line"></span>
                            </div>
                            <span class="holerite-date-slot-separator"></span>
                            <div class="holerite-date-slot holerite-date-slot--year">
                                <span class="holerite-date-slot-label">ANO</span>
                                <span class="holerite-date-slot-line"></span>
                            </div>
                        </div>
                        <span class="holerite-signature-label">DATA</span>
                    </div>
                    <div class="holerite-signature-assinatura">
                        <span class="holerite-signature-line"></span>
                        <span class="holerite-signature-label">ASSINATURA</span>
                    </div>
                </div>
            </div>
        </div>
