    ...
    <?php foreach ([
        ...
        <div class="holerite">
            ...
            <div class="holerite-signature">
                ...
                <div class="holerite-signature-footer" aria-hidden="true">
                    <div class="holerite-signature-date">
                        <span class="holerite-signature-date-label">DATA:</span>
                        <span class="holerite-date-field"></span>
                        <span class="holerite-date-separator">/</span>
                        <span class="holerite-date-field"></span>
                        <span class="holerite-date-separator">/</span>
                        <span class="holerite-date-field holerite-date-field--year"></span>
                    </div>
