    ...
    <div class="tab-container" data-default-tab="<?= htmlspecialchars($defaultTab); ?>">
        ...
        <div class="tab-content<?php if ($defaultTab === 'company'): ?> active<?php endif; ?>" id="tab-company">
            <div class="card">
                ...
                <form method="post" action="?action=update_company" style="margin-top:1rem;" enctype="multipart/form-data">
                    <div class="grid">
                        <div>
                            ...
                            <small class="muted">Esse texto aparece ao lado da logo na barra superior.</small>
                        </div>
                        <div>
