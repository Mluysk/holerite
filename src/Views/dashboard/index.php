...
<section class="dashboard">
    ...
    <div class="dashboard-metrics">
        ...
        <article class="stats-card stats-card--transport">
            <section class="transport-card__summary" aria-labelledby="transport-card-summary-title">
                <header class="transport-card__header">
                ...
                <dl class="transport-card__periods">
                    <div>
                        <dt>Este mês</dt>
                        <dd>R$ <?= number_format($transportCostCurrentMonth, 2, ',', '.'); ?></dd>
                    </div>
                    <div>
                        <dt>No ano</dt>
                        <dd>R$ <?= number_format($transportCostCurrentYear, 2, ',', '.'); ?></dd>
                    </div>
                </dl>
            </section>
