...
<section class="dashboard">
    ...
    <div class="dashboard-metrics">
        ...
        <article class="stats-card stats-card--vale">
            ...
            <header>
                <span class="stats-card__subtitle">Vales (inclui VT)</span>
    ...
    <section class="dashboard-vale">
        <header class="dashboard-vale__header section-heading section-heading--large">
            ...
            <div>
                ...
                <p class="muted">Acompanhe os descontos de vale, incluindo vale-transporte calculado automaticamente, mês a mês e ano a ano.</p>
            </div>
        </header>
            ...
            <div class="dashboard-vale__charts">
                <section class="dashboard-chart dashboard-chart--wide">
                    ...
                    <?php if ($monthlyValeChart['labels'] === []): ?>
                        <p class="muted">Os descontos mensais de vale e vale-transporte aparecerão conforme forem registrados.</p>
                    <?php else: ?>
                ...
                <section class="dashboard-chart dashboard-chart--wide">
                    ...
                    <?php if ($yearlyValeChart['labels'] === []): ?>
                        <p class="muted">Os totais anuais de vale e vale-transporte aparecerão após os primeiros registros.</p>
                    <?php else: ?>
                        <div class="chart-wrapper">
