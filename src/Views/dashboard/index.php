        ...
        <article class="stats-card stats-card--transport">
            <div class="transport-card__summary">
                <div class="transport-card__header">
                    <span class="transport-card__icon icon-circle icon-circle--info" aria-hidden="true">
                ...
                <div class="transport-card__amount">R$ <?= number_format($transportCostOverall, 2, ',', '.'); ?></div>
                <p class="transport-card__note">Consumo total de passagens fornecidas pela empresa.</p>
                <div class="transport-card__periods">
                    <div>
                        <span>Este mês</span>
                        <strong>R$ <?= number_format($transportCostCurrentMonth, 2, ',', '.'); ?></strong>
                    </div>
                    <div>
                        <span>No ano</span>
                        <strong>R$ <?= number_format($transportCostCurrentYear, 2, ',', '.'); ?></strong>
                    </div>
                </div>
            </div>
            <div class="transport-card__divider" role="presentation"></div>
            <div class="transport-card__shares">
                <div class="transport-card__share transport-card__share--employee">
                    <div class="transport-card__share-header">
                        <span class="transport-card__share-icon" aria-hidden="true">
                            <i class="bi bi-person-check-fill"></i>
                        </span>
                        <div>
                            <span class="transport-card__share-label">Colaborador (6%)</span>
                            <strong class="transport-card__share-amount">R$ <?= number_format($transportDeductionOverall, 2, ',', '.'); ?></strong>
                        </div>
                    </div>
                    <dl class="transport-card__share-meta">
                        <div>
                            <dt>Este mês</dt>
                ...
                <div class="transport-card__share transport-card__share--company">
                    <div class="transport-card__share-header">
                        <span class="transport-card__share-icon" aria-hidden="true">
                            <i class="bi bi-building-fill"></i>
                        </span>
                        <div>
                            <span class="transport-card__share-label">Custeio da empresa</span>
                            <strong class="transport-card__share-amount">R$ <?= number_format($transportCompanyOverall, 2, ',', '.'); ?></strong>
                        </div>
                    </div>
                    <dl class="transport-card__share-meta">
                        <div>
