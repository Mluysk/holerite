            ...
            <div class="transport-card__main">
                <div class="transport-card__summary">
                    ...
                    <div class="transport-card__summary-text">
                        ...
                        <span class="transport-card__note">Consumo total de passagens</span>
                    </div>
                </div>
                <div class="transport-card__aside">
                    <div class="transport-card__tile transport-card__tile--employee">
                        <div class="transport-card__tile-header">
                            <i class="bi bi-person-check-fill" aria-hidden="true"></i>
                            <span>Desconto (6%)</span>
                        </div>
                        <strong class="transport-card__tile-amount">R$ <?= number_format($transportDeductionOverall, 2, ',', '.'); ?></strong>
                        <dl class="transport-card__tile-meta">
                            <div>
                                <dt>Este mês</dt>
                    ...
                    <div class="transport-card__tile transport-card__tile--company">
                        <div class="transport-card__tile-header">
                            <i class="bi bi-building-fill" aria-hidden="true"></i>
                            <span>Custeio da empresa</span>
                        </div>
                        <strong class="transport-card__tile-amount">R$ <?= number_format($transportCompanyOverall, 2, ',', '.'); ?></strong>
                        <dl class="transport-card__tile-meta">
                            <div>
                                <dt>Este mês</dt>
