...
final class Payroll
{
    ...
    public function __construct(
        ...
        private float $transportTripCost,
    ...
    public function getTransportDays(): int
    {
        return $this->transportDays;
    }

    public function getTransportTrips(): int
    {
        return $this->transportDays * 2;
    }

    public function getTransportTripCost(): float
    {
    ...
    {
        return $this->advanceReferenceId;
    }
