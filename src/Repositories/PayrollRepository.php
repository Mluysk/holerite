...
final class PayrollRepository
{
    ...
    {
        $statement = $this->pdo->prepare('INSERT INTO payrolls (employee_id, reference_month, type, base_salary, total_allowances, total_deductions, net_salary, advance_amount, remaining_amount, vale_deduction, uses_transport, transport_deduction, payment_date, is_just_cause, vacation_days, worked_days, thirteenth_months, thirteenth_installment, thirteenth_accrual, inss_base, inss_amount, irrf_base, irrf_amount, fgts_base, fgts_amount, notes) VALUES (:employee_id, :reference_month, :type, :base_salary, :total_allowances, :total_deductions, :net_salary, :advance_amount, :remaining_amount, :vale_deduction, :uses_transport, :transport_deduction, :payment_date, :is_just_cause, :vacation_days, :worked_days, :thirteenth_months, :thirteenth_installment, :thirteenth_accrual, :inss_base, :inss_amount, :irrf_base, :irrf_amount, :fgts_base, :fgts_amount, :notes)');
        $statement->execute([
