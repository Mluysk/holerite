...
CREATE TABLE IF NOT EXISTS companies (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    brand_name VARCHAR(255) NOT NULL DEFAULT 'JP Fábrica de Salgados',
...
CREATE TABLE IF NOT EXISTS holiday_settings (
    id INT AUTO_INCREMENT PRIMARY KEY,
    include_national TINYINT(1) NOT NULL DEFAULT 1,
    include_optional TINYINT(1) NOT NULL DEFAULT 1,
    include_municipal TINYINT(1) NOT NULL DEFAULT 1,
    state VARCHAR(10) NOT NULL DEFAULT 'SP',
    city VARCHAR(120) NOT NULL DEFAULT '',
    municipal_holidays LONGTEXT NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
